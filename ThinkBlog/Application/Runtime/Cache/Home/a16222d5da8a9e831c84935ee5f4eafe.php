...
<div class="main"> 
  <div class="content" style="float:right;border:1px solid #ccc;background: white;"><!--xinjia beijingyanse-->
    <div class="content-head" style="height: 25px;background-image:url(/think/Public/images/modelhead.png);"><span class="addblog">全部留言</span></div>
